...
class PrinciplesPageCell : UICollectionViewCell {
    ...
    private func setupLayout() {
        ...
        bearImageView.anchor(top: topAnchor, left: leftAnchor, bottom: nil, right: nil, paddingTop: (frame.height / 5) - 12, paddingLeft: 24, paddingBottom: 0, paddingRight: 0, width: 100, height: 100)
