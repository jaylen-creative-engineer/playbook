...
class CommentNotification : UICollectionViewCell {
    ...
    let commentLabel : UILabel = {
        ...
        label.text = "Commented: Keep up the good work man"
        return label
    }()
    ...
    override init(frame: CGRect) {
        ...
        commentLabel.anchor(top: fullnameLabel.bottomAnchor, left: fullnameLabel.leftAnchor, bottom: nil, right: nil, paddingTop: 8, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: commentLabel.intrinsicContentSize.width, height: commentLabel.intrinsicContentSize.height)
    }
