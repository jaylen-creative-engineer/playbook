...
@IBDesignable class RollingPitTabBar: UITabBar {
    ...
    @IBInspectable public var barBackColor : UIColor = UIColor.blue
    @IBInspectable public var barHeight : CGFloat = 40
    ...
    override func prepareForInterfaceBuilder() {
        ...
        self.backgroundImage = UIImage(color: .clear)
        self.shadowImage = UIImage(color: .clear)
