...
class ProfileServices {
    ...
    func getAccount(userId : String, completion: @escaping (User) -> ()) {
        let url = ""
        var parameters = Alamofire.Parameters()
        parameters["userId"] = userId
    ...
    func getFollowersAndFollowing(userId : String, completion: @escaping (User) -> ()) {
        let url = ""
        var parameters = Alamofire.Parameters()
        parameters["userId"] = userId
    ...
    func updateAccount(userId : String, completion: @escaping (User) -> ()){
        let url = ""
        var parameters = Alamofire.Parameters()
        parameters["userId"] = userId
