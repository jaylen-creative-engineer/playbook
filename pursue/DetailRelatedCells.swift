...
class DetailRelatedCells : UICollectionViewCell {
...
extension DetailRelatedCells : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
