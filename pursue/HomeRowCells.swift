...
class HomeRowCells : UICollectionViewCell {
    ...
    func setupView() {
        ...
        postImage.anchor(top: topAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 32, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 280)
