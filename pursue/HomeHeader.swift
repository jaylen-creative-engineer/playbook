...
class HomeHeader : UICollectionViewCell {
    ...
    let yourPicksLabel : UILabel = {
       let label = UILabel()
        label.text = "Your Picks"
...
extension HomeHeader : iCarouselDataSource, iCarouselDelegate {
    ...
    func setupStandardCarousel(){
        ...
        addSubview(yourPicksLabel)
        addSubview(carouselView)
        addSubview(pageControl)

        yourPicksLabel.anchor(top: topAnchor, left: leftAnchor, bottom: nil, right: nil, paddingTop: 8, paddingLeft: 12, paddingBottom: 0, paddingRight: 0, width: yourPicksLabel.intrinsicContentSize.width, height: 20)
        carouselView.anchor(top: yourPicksLabel.bottomAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 18, paddingLeft: 0, paddingBottom: 0, paddingRight: 8, width: 0, height: 385)
