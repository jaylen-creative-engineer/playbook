...
class StepsPage : UICollectionViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout  {
    ...
    func setupView(){
        ...
        collectionView.register(StepsPageCell.self, forCellWithReuseIdentifier: "cellId")
