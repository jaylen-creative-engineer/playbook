...
class HomeStandardCell : UICollectionViewCell {
    ...
    func setupCollectionView(){
        ...
        collectionView.register(HomeStandard.self, forCellWithReuseIdentifier: cellId)
        ...
        pursuitImageView.anchor(top: userPhoto.bottomAnchor, left: cellBackgroundView.leftAnchor, bottom: nil, right: cellBackgroundView.rightAnchor, paddingTop: 18, paddingLeft: 12, paddingBottom: 0, paddingRight: 12, width: 0, height: 355)
        collectionView.anchor(top: pursuitImageView.bottomAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 24, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 170)
    }
...
extension HomeStandardCell : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! HomeStandard
        return cell
    }
}
