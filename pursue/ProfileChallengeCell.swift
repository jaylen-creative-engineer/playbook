...
class ProfileChallengeCell : UICollectionViewCell {
    ...
    func setupView(){
        ...
        photo.roundCorners(corners: [.topLeft, .topRight], radius: 8.0)
        photo.anchor(top: cellTopBackground.topAnchor, left: cellTopBackground.leftAnchor, bottom: nil, right: cellTopBackground.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: (frame.height / 2) + 26)
        ...
        detailLabel.anchor(top: photo.bottomAnchor, left: cellTopBackground.leftAnchor, bottom: userPhoto.topAnchor, right: cellTopBackground.rightAnchor, paddingTop: 10, paddingLeft: 18, paddingBottom: 18, paddingRight: 12, width: 0, height: 0)
    }
