...
class ProfileAddedRow : UICollectionViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! PeopleAddedCells
    ...
    func setupView(){
        ...
        postCollection.register(PeopleAddedCells.self, forCellWithReuseIdentifier: cellId)
