...
class DiscussionPursuitsView : UICollectionViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! DiscussionPursuitsCells
        return cell
    }
    ...
    override init(frame: CGRect) {
        ...
        pursuitSteps.register(DiscussionPursuitsCells.self, forCellWithReuseIdentifier: cellId)
    }
